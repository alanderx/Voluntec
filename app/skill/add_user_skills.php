...
try {
     ...
     */
    $stmt_delete = $conn->prepare("DELETE FROM volunteer_skill WHERE volunteer_id = ?");
     ...
     */
    $stmt_insert = $conn->prepare("INSERT INTO volunteer_skill (volunteer_id, skill_id) VALUES (?, ?)");
